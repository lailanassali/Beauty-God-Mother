...
class RBViewController: UIViewController {
    ...
    public func handleRegister() {
       ...
       // Stage 2
        if !rs.passwordMatches(p1: password, p2: confirmPassword, viewController: self) || !rs.passwordMustBe8Characters(p1: password, p2: confirmPassword, viewController: self) || !rs.nameFormatIsCorrect(name: name, viewController: self) { return }

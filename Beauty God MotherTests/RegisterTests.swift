...
class RegisterTests: XCTestCase {
    ...
    func testShouldSucceedToRegisterIfPasswordsAreMoreThan8CharactersLong() {
        let result = registerService.passwordMustBeMoreThan8Characters(p1: "12345678910", p2: "12345678910", viewController: viewController)
        XCTAssertEqual(result, true)
    }
    
    func testShouldFailToRegisterIfPasswordsAreLessThan8CharactersLong() {
        let result = registerService.passwordMustBeMoreThan8Characters(p1: "123", p2: "123", viewController: viewController)
        XCTAssertEqual(result, false)
    }
